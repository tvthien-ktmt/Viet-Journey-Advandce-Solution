-- Flyway Migration: Quản lý version hóa Database Schema
-- Tại sao cần Flyway thay vì hibernate.ddl-auto = update?
-- - ddl-auto=update: Hibernate tự đoán schema dựa trên Entity → nguy hiểm
--   khi deploy production (có thể DROP column chứa data thật)
-- - Flyway: Schema thay đổi được versioning rõ ràng (V1, V2, V3...)
--   → rollback được, audit được, team biết ai đổi gì lúc nào
-- - File này (V1) chỉ chạy 1 lần khi database mới tạo
-- - Các thay đổi sau (thêm cột, thêm index...) sẽ là file V2, V3...
