...
public class AuthControllerTest {
    ...
    void register_ValidBody_ReturnsOk() throws Exception {
        ...
        com.vietjourney.backend.dto.response.UserDTO mockUserDTO = com.vietjourney.backend.dto.response.UserDTO.builder().email("test@example.com").build();
        AuthResponse mockResponse = AuthResponse.builder().token("mockToken").user(mockUserDTO).build();
