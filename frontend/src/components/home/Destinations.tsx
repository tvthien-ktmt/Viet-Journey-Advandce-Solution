    ...
    <section id="destinations" className="vna-tint-bg-2 py-14 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="mb-8 flex flex-wrap items-end justify-between gap-3">
          <div>
            <h2 className="text-2xl font-extrabold tracking-tight text-[#023a78] sm:text-3xl">{t.sections.destinations}</h2>
            <p className="mt-1 text-sm text-slate-500">{t.sections.destinationsSub}</p>
          </div>
            ...
            >
              <div className="relative aspect-[4/3] overflow-hidden">
                ...
                <div className="absolute right-2 top-2 rounded-full bg-[#f5a623] px-2.5 py-1 text-[11px] font-bold text-[#023a78] shadow">
                  {t.sections.fromPrice} {formatVND(d.fromPriceVND)}
                </div>
                <div className="absolute bottom-0 left-0 right-0 p-3 text-white">
                  ...
                  <div className="text-lg font-bold leading-tight drop-shadow">{lang === 'vn' ? d.city : d.cityEn}</div>
                </div>
              </div>
            </a>
          ))}
