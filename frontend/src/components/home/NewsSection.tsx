      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="mb-8 flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <h2 className="text-2xl font-extrabold tracking-tight text-[#023a78] sm:text-3xl">{_t.sections.news}</h2>
            <p className="mt-1 text-sm text-slate-500">{_t.sections.newsSub}</p>
          </div>
        </div>
            ...
            <article key={n.id} className="group flex flex-col gap-3 rounded-xl border border-slate-200 bg-white p-5 shadow-sm transition-all hover:border-[#1f6fb2]/40 hover:shadow-md sm:flex-row">
              ...
              <div className="flex-1">
                ...
                <Button
                  ...
                  onClick={() => toast.success(_t.common.readMore, { description: n.title })}
                >
                  {_t.common.readMore}
